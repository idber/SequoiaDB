/*******************************************************************************
   ...
   Source File Name = sptDBRegex.hpp
...
*******************************************************************************/
#ifndef SPT_DB_REGEX_HPP
#define SPT_DB_REGEX_HPP
#include "sptApi.hpp"
namespace engine
{
   class _sptDBRegex : public SDBObject
   {
      JS_DECLARE_CLASS( _sptDBRegex )
   public:
      _sptDBRegex() ;
      virtual ~_sptDBRegex() ;
   public:
   ...
   typedef _sptDBRegex sptDBRegex ;
}
#endif