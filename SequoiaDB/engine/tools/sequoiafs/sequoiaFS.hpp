...
namespace sequoiafs
{
    ...
    public:
        ...
        INT32 getdir(const CHAR *path, fuse_dirh_t dirh, fuse_dirfil_t dirfill);
        ...
        INT32 write(const CHAR *path, const CHAR *buf, size_t size, off_t offset,
                  struct fuse_file_info *fi);
        ...
        INT32 fsync(const CHAR *path, INT32 datasync, struct fuse_file_info *fi);
        INT32 setxattr(const CHAR *path, const CHAR *name, const CHAR *value, size_t size, INT32 flags);
        INT32 getxattr(const CHAR *path, const CHAR *name, CHAR *value, size_t size);
        ...
        INT32 readdir(const CHAR *path, void *buf, fuse_fill_dir_t filler, off_t offset,
                     struct fuse_file_info *fi);
        INT32 releasedir(const CHAR *path, struct fuse_file_info *fi);
        INT32 fsyncdir(const CHAR *path, INT32 datasync, struct fuse_file_info *fi);
        INT32 access(const CHAR *path, INT32 mask);
        INT32 create(const CHAR *path, mode_t mode, struct fuse_file_info *fi);
        INT32 ftruncate(const CHAR *path, off_t offset, struct fuse_file_info *fi);
        INT32 fgetattr(const CHAR *path, struct stat *buf, struct fuse_file_info *fi);
        INT32 lock(const CHAR *path, struct fuse_file_info *fi, INT32 cmd,
                  struct flock *lock);
        ...
        INT32 fallocate(const CHAR *path, INT32 mode, off_t offset, off_t value,
                        struct fuse_file_info *fi);
